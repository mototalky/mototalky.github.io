...
(function() {
	new Slideshow( document.getElementById( 'slideshow-phone-left' ) );
    new Slideshow( document.getElementById( 'slideshow-phone-left-2' ) );

	/* Mockup responsiveness */
	var body = docElem = window.document.documentElement,
		wrap = document.getElementById( 'wrap-phone-left' ),
		mockup = wrap.querySelector( '.mockup-phone-left' ),
		mockup2 = wrap.querySelector( '.mockup-phone-right' ),
		mockupWidth = mockup.offsetWidth;

	// Custom Mods
	var wrap2 = document.getElementById( 'wrap-phone-left-2' ),
		mockup_wrap2 = wrap2.querySelector('.mockup-phone-left');
	...
	function scaleMockup() {
		...
		document.getElementById( 'mockup2' ).style.transform = 'scale3d(' + val + ', ' + val + ', 1)';

		// Modify left phone
        mockup_wrap2.style.transform = 'scale3d(' + val + ', ' + val + ', 1)';
	}
